...
@section('content')
              ...
              <div class="col-md-6 order-md-2">
                <div class="row justify-content-end">
                  <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">About us</span>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">Crafting breathtaking fireworks shows that captivate every audience</h2>
                    <div data-aos="fade-up" data-aos-delay="200">
                      <p>Born from a passion for pyrotechnics, Kenseep Executive Fireworks delivers premium fireworks sales, display design, and on-site execution for events across East Africa.</p>
                      <p>From intimate celebrations to national spectacles, our certified team blends artistry with rigorous safety standards to transform every moment into a sky full of wonder.</p>
                    </div>
                    <h4 class="small fw-bold mt-4 mb-3" data-aos="fade-up" data-aos-delay="300">Our Promise</h4>
                    <ul class="d-flex flex-row flex-wrap list-unstyled gap-3 features" data-aos="fade-up" data-aos-delay="400">
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">Safety First</span></li>
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">Creative Design</span></li>
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">Premium Effects</span></li>
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">On-Time Delivery</span></li>
                      <li class="d-flex align-items-center gap-2"><span class="icon rounded-circle text-center"><i class="bi bi-check"></i></span><span class="text">Customer Delight</span></li>
                    </ul>
                  </div>
                </div>
              </div>
                ...
                <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="{{ asset('assets/images/kenseep.jpg') }}" alt="FreeBootstrap.net image placeholder" data-aos="fade-up" data-aos-delay="0">
                  <div class="mission-statement p-4 rounded-4 d-flex gap-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                      ...
                      <p class="fs-5 mb-0">We ignite celebrations with innovative pyrotechnic artistry, meticulous safety, and unforgettable experiences for every client.</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="row">
                        <div class="col-lg-11">
                          <div class="h-100 flex-column justify-content-between d-flex">
                            <div>
                              <h2 class="mb-4">Why choose Kenseep</h2>
                              <p class="mb-5">Partner with a pyrotechnic team that blends creative storytelling with world-class safety to deliver custom fireworks shows, consumer packages, and special effects that wow every crowd.</p>
                            </div>
                            <div class="align-self-start"><a class="glightbox btn btn-play d-inline-flex align-items-center gap-2" href="https://www.youtube.com/watch?v=DQx96G4yHd8" data-gallery="video"><i class="bi bi-play-fill"></i> Watch Our Shows</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-lg-11">
                          <div class="row">
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="0">
                              ...
                              <h3 class="fs-6 fw-bold mb-3">Custom Show Design</h3>
                              <p>Inspired choreography tailored to your event theme, venue, and audience.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="100">
                              <div class="icon text-center mb-4"><i class="bi bi-graph-up fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Licensed Pyrotechnicians</h3>
                              <p>Certified experts managing every launch with precision and control.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="icon text-center mb-4"><i class="bi bi-headset fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">End-to-End Support</h3>
                              <p>Site inspections, authority approvals, and logistics handled for you.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="300">
                              <div class="icon text-center mb-4"><i class="bi bi-shield-lock fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3">Premium Effects</h3>
                              <p>High-quality shells, special effects, and synchronized lighting for maximum impact.</p>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <section class="section pricing__v2" id="pricing">
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-5 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Packages</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Spectacular options for every celebration</h2>
                <p data-aos="fade-up" data-aos-delay="200">Select a fireworks experience tailored to your event size, budget, and vision—always executed safely by our experts.</p>
              </div>
            </div>
            <div class="row">
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-6 text-center mx-auto"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">How it works</span>
                <h2 data-aos="fade-up" data-aos-delay="100">Bringing your skyline to life</h2>
                <p data-aos="fade-up" data-aos-delay="200">We handle every detail of your fireworks experience—from your first idea to the final spark—so you can enjoy the show stress-free.</p>
              </div>
            </div>
            <div class="row g-md-5">
              ...
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                <div class="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">4</span>
                  <div>
                    <h3 class="fs-5 mb-4">Showtime Magic</h3>
                    <p>We execute every launch with precision, deliver post-show reporting, and leave the site spotless.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-8 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Our Services</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Lighting up every moment with tailored pyrotechnic solutions</h2>
              </div>
            </div>
            <div class="row g-4">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Display Production</h3>
                    <p class="mb-4">Full-service show planning, from concept and choreography to on-site crew and synchronized firing systems.</p>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Event Pyro Planning</h3>
                    <p class="mb-4">Venue assessments, safety plans, and authority liaison to deliver compliant displays without the stress.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Pyromusical Design</h3>
                    <p class="mb-4">Music-synced fireworks and special effects that build emotion and tell your story in the sky.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Fireworks Retail</h3>
                    <p class="mb-4">Premium consumer fireworks packages, curated for DIY celebrations and delivered with guidance.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Special Effects</h3>
                    <p class="mb-4">CO₂ jets, cold spark fountains, confetti, and stage pyrotechnics to enhance concerts, weddings, and launches.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Safety & Compliance</h3>
                    <p class="mb-4">Risk assessments, insurance coverage, and post-show reporting to keep every production secure and accountable.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-lg-5 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Testimonials</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Celebrations that speak for themselves</h2>
                <p data-aos="fade-up" data-aos-delay="200">Hear how Kenseep Executive Fireworks elevates weddings, festivals, and brand launches across the region.</p>
              </div>
            </div>
            <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    Kenseep turned our wedding night into pure magic. The custom choreography matched our music perfectly, and the team handled every detail with such care.
                    &rdquo;
                  </blockquote>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    Our New Year countdown at the hotel has never looked better. Guests are still talking about the vibrant colors and safe, seamless execution.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    Their pyromusical for our corporate anniversary aligned flawlessly with our brand story. The reveal was timed to the second and left the crowd energized.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    The team coordinated with local authorities, briefed our security staff, and delivered a flawless sports halftime show. Professional from start to finish.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    Safety was our top priority for the community festival. Kenseep’s comprehensive planning and clear communication put everyone at ease.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="testimonial rounded-4 p-4">
                  <blockquote class="mb-3">
                     &ldquo;
                    From early design mockups to the final spark, their service exceeded expectations. The rooftop launch for our product reveal stole the spotlight.
                    &rdquo;
                  </blockquote>
                  <div class="testimonial-author d-flex gap-3 align-items-center">
          ...
          <div class="container">
            <div class="row mb-4">
              <div class="col-md-6 col-lg-7 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">FAQ</span>
                ...
                <p data-aos="fade-up" data-aos-delay="100">Everything you need to know about booking fireworks, working with our crew, and creating a safe, spectacular show.</p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="d-flex gap-5 flex-column">
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="0">
                    <div class="icon d-block"><i class="bi bi-telephone"></i></div><span> <span class="d-block">Phone</span><strong>+255 673 443 706</strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="100">
                    <div class="icon d-block"><i class="bi bi-send"></i></div><span> <span class="d-block">Email</span><strong>kenseepexecutivefireworks@gmail.com</strong></span>
                  </div>
                  <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="200">
                    <div class="icon d-block"><i class="bi bi-geo-alt"></i></div><span> <span class="d-block">Address</span>
                      <address class="fw-bold">Dar es Salaam, Tanzania<br>Available nationwide</address></span>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
